...
class Raider(User):
    def __init__(self, name, email, nid, current_location, initial_amount):
        ...
        self.wallet = int(initial_amount)
        self.current_location = current_location

    def display_profile(self):
        print(f"Raider: {self.name} and email{self.email} ")
    ...
    def show_current_ride(self):
        ...
        print(f"Select Car : {self.current_ride.vehicle.vehicle_type}")
        print(f"Start Location : {self.current_ride.start_location}")
        print(f"End Location : {self.current_ride.end_location}")
        print(f"Total Cost : {self.current_ride.estimated_cost}")
